...
def k_means_vector_gpu_fp32(weight_vector, n_clusters, verbosity=0, seed=int(time.time()), gpu_id=7, epoch=0, labels_new=[], centers_new=[]):
    ...
    if n_clusters == 1:
        ...
        return weight_vector_compress, labels.astype('int32'), centers.astype('float32')
